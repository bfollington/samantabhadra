...
export function SettingsPanel({
  ...
  const [editingPersona, setEditingPersona] = useState<EmojiPersona | null>(
    null
  );
  ...
  const isEmojiTaken = (emoji: string) => {
    return personas.some(
      (p) => p.emoji === emoji && p.id !== editingPersona?.id
    );
  };
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <Card className="p-4">
            ...
            <div className="flex items-center gap-4">
              <Button
                variant={
                  currentModel === OPENAI_MODEL_NAME ? "primary" : "secondary"
                }
              ...
              <Button
                variant={
                  currentModel === ANTHROPIC_MODEL_NAME
                    ? "primary"
                    : "secondary"
                }
                        ...
                        <div>
                          ...
                          {persona.model_preference && (
                            <p className="text-xs text-neutral-500 mt-1">
                              Prefers:{" "}
                              {persona.model_preference === OPENAI_MODEL_NAME
                                ? "GPT-4"
                                : "Claude"}
                            </p>
                          )}
